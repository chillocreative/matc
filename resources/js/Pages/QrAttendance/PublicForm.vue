...
const categoryColors = {
    anggota: { text: 'text-sky-300', badge: 'bg-sky-400/15 text-sky-300 ring-sky-400/20' },
    ajk_cabang: { text: 'text-amber-300', badge: 'bg-amber-400/15 text-amber-300 ring-amber-400/20' },
